...
class LastHopeHead_v2(ASPPHead):
    ...
    def __init__(self, c1_in_channels, c1_channels,
                 ...
                 **kwargs):
        super(LastHopeHead_v2, self).__init__(**kwargs)
    ...
    def get_subnetworks_params(self, attns, num_bases=0, channels=16):
        ...
        w0, b0, w1, b1, w2, b2 = torch.split_with_sizes(attns, [
            (2) * channels, channels,
            (channels + num_bases) * channels, channels,
        ...
        w1 = w1.reshape(n_inst * channels, channels + num_bases, 1, 1)

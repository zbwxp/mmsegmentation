...
class DynConvHead_fast(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 tower_num_convs=0,
                 **kwargs):
        super(DynConvHead_fast, self).__init__(**kwargs)
    ...
    def forward(self, inputs):
        ...
        x1 = self.stage5_head(features[-1])
        ...
        if self.use_low_level_info:
            ...
            if self.use_aligned_bilinear:
                ...
                x_tower = resize(x_tower,
                                 ...
                                 mode='bilinear',
                                 align_corners=self.align_corners)
            output = self.interpolate_fast(x, x_tower, self.cat_norm)
        else:

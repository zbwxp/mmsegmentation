...
class DynASPPHead(BaseDecodeHead):
    ...
    def __init__(self,
                 ...
                 dilations=(1, 3, 6, 9),
                 **kwargs):
        super(DynASPPHead, self).__init__(**kwargs)
    ...
    def forward(self, inputs):
        ...
        # last_stage = self.psp_forward(features)
        ...
        last_stage = self.bottleneck(aspp_outs)

        x = self.classifier(last_stage)
        if self.use_low_level_info:
